...
void LocationCourier() {
    ...
    for(;;) {
        ...
        cuassert(producer_rply.type == LOCATION_SERVER_MESSAGE, "Invalid Response from SensorServer");
        cuassert(producer_rply.ls_msg.type == LOCATION_COURIER_REQUEST, "Invalid Courier Message");
        ...
        for (i = 0; i < MAX_SUBSCRIBERS; ++i) {
            ...
            while(subscriber) {
                ...
                cuassert(consumer_rply.ss_msg.type == LOCATION_COURIER_RESPONSE, "Invalid Response from Consumer");
